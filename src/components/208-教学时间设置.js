...
import { ChevronLeft, Info, CheckCircle, X, AlertTriangle } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen bg-gray-50 max-w-md mx-auto">
      ...
      <div className="bg-white px-4 py-3.5 flex items-center border-b border-gray-200">
        ...
        <div className="flex-1 flex justify-center">
          <h1 className="text-lg font-semibold text-gray-800">My Availability</h1>
        </div>
        <button 
      ...
      <div className="bg-white border-t border-gray-200 p-4">
        <div className="flex space-x-3">
          <button
            className="w-1/3 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-medium"
          ...
          <button
            ...
            } rounded-lg font-medium flex justify-center items-center`}
