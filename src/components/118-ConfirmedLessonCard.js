  ...
  return (
    <div className="flex flex-col bg-gray-50 max-w-md mx-auto h-full">
      ...
      <div className="flex-1 overflow-auto px-4">
        {/* 状态标签和提示 */}
        <div className="py-3 bg-primary-50 border-b border-primary-200 -mx-4 px-4 mb-4">
          ...
          <div className="mt-2 text-sm text-primary-600 flex items-start" role="alert">
            <span className="material-icons-round text-primary-600 mr-1.5 flex-shrink-0">check_circle</span>
            <span>
              Your lesson has been confirmed by the coach. Please arrive 10 minutes before your scheduled time.
            </span>
          </div>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center px-2.5 py-0.5 bg-purple-100 text-purple-600 text-xs font-medium rounded">
                      Forehand
                    </span>
                    <span className="inline-flex items-center px-2.5 py-0.5 bg-purple-100 text-purple-600 text-xs font-medium rounded">
                      Backhand
        ...
        <section className="mb-6">
          <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
            <div className="flex items-start">
              <span className="material-icons-round text-purple-500 mr-2 mt-0.5 flex-shrink-0">alarm</span>
              <div>
                <p className="text-sm text-purple-700 font-medium mb-1">Your lesson is in 3 days</p>
                <p className="text-xs text-purple-600">
                  Remember to arrive 10 minutes early and bring your equipment. If you need to reschedule, please do it at least 24 hours before.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex space-x-3 mb-6">
          <button 
            className="flex-1 px-4 py-2.5 border border-red-500 text-red-600 rounded-lg text-center flex items-center justify-center"
          ...
          <button 
            ...
            aria-label="Mark this lesson as completed"
          >
            Completed
          </button>
        </div>
...
export default ConfirmedLessonCard; 