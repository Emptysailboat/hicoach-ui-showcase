    ...
    >
      <div className="flex items-start">
        ...
        <div className={`${isMiniCard ? 'ml-3' : 'ml-4'} flex-1 min-w-0 relative`}>
          ...
          {onMessage && (
            <button 
              className="absolute bottom-2 right-2 w-9 h-9 flex items-center justify-center border-2 border-green-600 bg-white text-green-600 rounded-lg shadow-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-green-400 hover:border-green-700 hover:bg-gray-50 active:bg-gray-100"
